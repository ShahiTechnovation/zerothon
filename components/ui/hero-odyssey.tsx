  ...
  useEffect(() => {
    ...
    const fragmentShaderSource = `
      ...
      void mainImage( out vec4 fragColor, in vec2 fragCoord ) {
          ...
          vec3 col = baseColor * pow(mix(0.0, 0.07, hash11(iTime * uSpeed)) / (dist + 0.1), 1.0) * uIntensity;
    ...
    const render = () => {
      if (!canvas || !glRef.current || !program) return
...
export { Lightning, ElasticHueSlider }
